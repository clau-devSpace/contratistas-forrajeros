    ...
    <>
      <nav>
        ...
        <div className="nav-items">
          <a href="#" className="btn-asociate">Asóciate</a>
      ...
      <div className={`menu-container ${isMenuOpen ? 'active' : ''}`}>
        <div className="menu-content">
              ...
              {menuItems.map((item, index) => (
                <li key={item.id} style={{ animationDelay: `${index * 0.1}s` }}>
                  <a 
                    ...
                    onClick={item.hasSubmenu ? (e) => handleSubmenuClick(e, item.id) : undefined}
                  >
                    <span>
                    ...
                    {item.hasSubmenu && (
                      <i 
                        className={`bi bi-chevron-right expand-indicator ${activeMobileSubmenu === item.id ? 'expanded' : ''}`}
          ...
          <div className="submenu-container">
            <ul className={`submenu ${activeDesktopSubmenu === 'nosotros' ? 'active' : ''}`}>
              <li><a href="#">Misión, Visión y Valores</a></li>
              <li><a href="#">Junta Directiva</a></li>
              <li><a href="#">Nuestros Socios</a></li>
              <li><a href="#">Convenios</a></li>
              <li><a href="#">Quiero Asociarme</a></li>
            </ul>

            <ul className={`submenu ${activeDesktopSubmenu === 'areas' ? 'active' : ''}`}>
              <li><a href="#">Área Económica</a></li>
